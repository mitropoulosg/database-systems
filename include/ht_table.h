...
typedef struct {
    ...
    long int numBuckets; 
    char file_type[12];
    int buckets[15][2];       //πρωτη στηλη = αρχη, δευτερη = τελος 
                              //απο εκφωνηση θεωρουμε μικρο αριθμο bucket (15)
    int rec_capacity;
...
//Στατιστικές μετρήσεις ενός υπάρχων αρχείου ht με όνομα filename
